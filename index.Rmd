...
2. Download the latest release of jsPsych, which as of now is jsPsych 8.1.0. The jsPsych software is a set of files located in the Dist Archive zipped folder
...
**show_clickable_nav**: Show the previous/next buttons<br>
...
![](images/rentals_trial1.png){width=60%}
...
![](images/rentals_trial1.png){width=60%}<br>
![](images/rentals_trial2.png){width=60%}<br>
![](images/rentals_trial3.png){width=60%}
